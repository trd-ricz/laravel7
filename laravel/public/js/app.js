...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])('posts/', ['getPostById'])),
  mounted: function mounted() {
    this.defaultPost(this.defaultPosts);
    this.increment(this.defaultPosts.length);
  },
  beforeDestroy: function beforeDestroy() {},
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])('posts/', ['addPost', 'increment', 'deletePost', 'decrement', 'updatePost', 'defaultPost']), {
...
var render = function() {
  ...
  return _c("div", { staticStyle: { height: "100%" } }, [
    ...
    _c(
      ...
      _vm._l(_vm.posts, function(post) {
        return _c("li", [
          ...
          _vm._v(" "),
          _c("p", [_vm._v(" Author : " + _vm._s(post.author) + " ")]),
          _vm._v(" "),
          _c("p", [_vm._v(" Date : " + _vm._s(post.date) + " ")]),
          _vm._v(" "),
          _c(
            "button",
            {
              on: {
                click: function($event) {
                  return _vm.deletePost(post.row_id)
                }
              }
            },
            [_vm._v("Delete")]
          ...
          _c(
            "button",
            {
              on: {
                click: function($event) {
                  return _vm.editPost(post.row_id)
                }
              }
            },
            [_vm._v("Edit")]
    ...
    _vm.isEdit
      ...
      : _c("button", { on: { click: _vm.submitPost } }, [_vm._v("Submit")])
  ])
}
var staticRenderFns = []
render._withStripped = true
...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  components: {
    Home: _components_Home__WEBPACK_IMPORTED_MODULE_2__["default"],
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  modules: {
    posts: _modules_Post__WEBPACK_IMPORTED_MODULE_2__["default"]
  }
}));
...
var Posts = {
  ...
  mutations: {
    increment: function increment(state, pl) {
      if (pl) {
        state.count += pl;
      } else {
        state.count++;
    ...
    decrement: function decrement(state, pl) {
      state.count--;
    },
    addPost: function addPost(state, pl) {
      state.post.push(pl);
    },
    defaultPost: function defaultPost(state, pl) {
      state.post = pl;
    },
    deletePost: function deletePost(state, pl) {
      var newSetOfPost = [];
      state.post.forEach(function (value, key) {
        if (value.row_id == pl) {
          state.post.splice(key, 1);
        }
      });
    },
    updatePost: function updatePost(state, pl) {
      var newSetOfPost = [];
      state.post.map(function (value) {
  ...
  actions: {
    increment: function increment(context, pl) {
      context.commit('increment', pl);
    },
    addPost: function addPost(context, pl) {
      context.commit('addPost', pl);
    },
    defaultPost: function defaultPost(context, pl) {
      context.commit('defaultPost', pl);
    },
    deletePost: function deletePost(context, pl) {
      context.commit('deletePost', pl);
    },
    decrement: function decrement(context, pl) {
      context.commit('decrement');
    },
    updatePost: function updatePost(context, pl) {
  ...
  getters: {
    getPostById: function getPostById(state) {
      return function (id) {
        return state.post.find(function (post) {
          return post.row_id === id;
        });
      };
    }
  }
